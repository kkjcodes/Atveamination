      ...
      <div className="max-w-3xl mx-auto py-12 px-6 space-y-10">
        ...
        <section className="space-y-3">
          ...
          <div className="space-y-3 text-sm text-zinc-600">
            <p>
              <span className="font-medium text-zinc-800">Your own likeness and voice only.</span> You may only upload photos and record voice audio of yourself, or of another real person who has given you explicit written consent. If you use any other person&rsquo;s likeness or voice, you represent and warrant that you have obtained their prior, explicit, written consent specifically authorizing their likeness and voice to be used on {B} for AI-generated content. Uploading another person&rsquo;s likeness without this consent is a material breach of these Terms.
            </p>
            <p>
            ...
            <p>
              <span className="font-medium text-zinc-800">Biometric voice consent.</span> By using the microphone recording feature, you explicitly consent to the collection, processing, and storage of your vocal characteristics solely for the purpose of generating AI-animated video narration within the service. We do not use your voice recordings to create permanent biometric profiles, sell your voice data, or use it for any purpose beyond generating your videos. Your raw voice recording is retained in Azure Blob Storage and associated with your account until you delete your character or account, at which point it is permanently deleted. During generation, your voice recording is transmitted to Replicate for voice cloning; this transmission is covered by Replicate&rsquo;s privacy policy.
            </p>
            <p>
              <span className="font-medium text-zinc-800">Right to demand proof of consent.</span> {B} reserves the right, at any time and for any reason, to demand that you provide documentary proof of any consent you claim to hold. Failure to produce such proof within 48 hours of a request will result in immediate account termination and removal of the relevant content.
            </p>
            <p>
              <span className="font-medium text-zinc-800">Indemnification for likeness and privacy claims.</span> If any claim is brought against {B} by any third party arising from your use of their likeness, voice, image, or personal data — including claims under right-of-publicity laws, privacy laws, defamation law, or any other theory — you agree to fully defend, indemnify, and hold harmless {B} and its operator from all resulting damages, costs, and legal fees, as further described in Section 8. This obligation survives termination of your account.
            </p>
            <p>
              <span className="font-medium text-zinc-800">You own your output.</span> You retain ownership of content you generate. By using the service you grant {B} a limited, non-exclusive, royalty-free license to store and process your content solely to provide the service.
            </p>
            <p>
              <span className="font-medium text-zinc-800">You are responsible for your content.</span> {B} does not monitor, review, or take responsibility for content you generate. Any use, sharing, or publication of generated content is entirely your own decision and your sole responsibility.
            </p>
          </div>
        </section>
        ...
        <section className="space-y-3">
          ...
          <div className="space-y-3 text-sm text-zinc-600">
            <p>You may not use {B} to generate, store, or distribute content that is:</p>
            ...
            <p>Violations will result in immediate account termination and may be reported to law enforcement. {B} reserves the right to remove any content and terminate any account at any time, for any reason, without notice.</p>
          </div>
        </section>

        <section className="space-y-3">
          <h2 className="text-xl font-semibold text-zinc-800 border-b border-zinc-200 pb-2">5. Free Service and Usage Limits</h2>
          <div className="space-y-3 text-sm text-zinc-600">
            <p>{B} is currently free to use, subject to fair-usage limits (such as daily and monthly generation allowances) shown in the product. We may adjust these limits at any time to keep the service available for everyone.</p>
            <p>Generations that fail for reasons on our side do not count against your allowance.</p>
          </div>
        </section>
        ...
        <section className="space-y-3">
          ...
          <div className="space-y-3 text-sm text-zinc-600">
            <p className="uppercase font-medium">
              TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, {B.toUpperCase()} AND ITS OPERATOR SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, PUNITIVE, OR EXEMPLARY DAMAGES OF ANY KIND, INCLUDING BUT NOT LIMITED TO LOSS OF DATA, LOSS OF REVENUE, LOSS OF PROFITS, LOSS OF GOODWILL, PERSONAL INJURY, OR ANY OTHER LOSS ARISING OUT OF OR IN CONNECTION WITH YOUR USE OF OR INABILITY TO USE THE SERVICE, EVEN IF ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.
            </p>
            <p className="uppercase font-medium">
              IN NO EVENT SHALL OUR TOTAL CUMULATIVE LIABILITY TO YOU FOR ALL CLAIMS ARISING FROM OR RELATED TO THESE TERMS OR THE SERVICE EXCEED THE GREATER OF (A) THE TOTAL AMOUNT YOU PAID US IN THE TWELVE MONTHS PRECEDING THE CLAIM OR (B) FIFTY US DOLLARS ($50).
            </p>
        ...
        <section className="space-y-3">
          ...
          <div className="space-y-3 text-sm text-zinc-600">
            <p>{B} uses third-party AI models hosted by Replicate, fal.ai, and Anthropic. These models are operated independently; {B} does not control their outputs and is not responsible for any content they produce.</p>
        ...
        <section className="space-y-3">
          ...
          <div className="space-y-3 text-sm text-zinc-600">
            <p>{B} respects intellectual property rights and complies with the Digital Millennium Copyright Act (DMCA). If you believe that content on the service infringes your copyright, you may submit a written notice to us at <span className="font-medium text-zinc-800">{BRAND.supportEmail}</span> with the subject line &ldquo;DMCA Takedown Request&rdquo; including:</p>
            <ul className="list-disc pl-5 space-y-1.5">
            ...
            <p>Upon receiving a valid DMCA notice, {B} will expeditiously remove or disable access to the allegedly infringing content and notify the user who uploaded it. Repeat infringers will have their accounts terminated.</p>
            <p>You may not upload, animate, or use any copyrighted image, artwork, or media as input to {B} without authorization from the rights holder. Doing so is a violation of these Terms and applicable law.</p>
          </div>
        </section>

        <section className="space-y-3">
          <h2 className="text-xl font-semibold text-zinc-800 border-b border-zinc-200 pb-2">11. Termination</h2>
          <p className="text-sm text-zinc-600">{B} may suspend or terminate your account at any time, for any reason or no reason, without notice or liability. You may stop using the service and delete your account at any time. Upon termination, your right to use the service ceases immediately.</p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <div className="space-y-3 text-sm text-zinc-600">
            <p>{B} is provided on a best-effort basis. The service may be interrupted, modified, or discontinued at any time without notice. {B} has no obligation to maintain, support, or continue operating the service.</p>
            <p>The {B} platform, branding, and code are proprietary. Nothing in these Terms grants you a right to use {B}&rsquo;s name, logo, or trademarks. You may not copy, reverse-engineer, scrape, or create derivative works of the platform.</p>
          </div>
        </section>
        ...
        <section className="space-y-3">
          ...
          <div className="space-y-3 text-sm text-zinc-600">
            ...
            <p><strong>Informal resolution first.</strong> If you have a dispute with {B}, you agree to first contact us at {BRAND.supportEmail} and attempt to resolve it informally for at least 30 days before initiating any formal proceeding.</p>
            ...
            <p><strong>Class action waiver.</strong> YOU AND {B.toUpperCase()} EACH AGREE THAT ANY CLAIM SHALL BE BROUGHT ONLY IN YOUR INDIVIDUAL CAPACITY AND NOT AS A PLAINTIFF OR CLASS MEMBER IN ANY PURPORTED CLASS, CONSOLIDATED, OR REPRESENTATIVE PROCEEDING. The arbitrator may not consolidate more than one person&rsquo;s claims.</p>
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm text-zinc-600">These Terms are governed by the laws of the State of Delaware, United States, without regard to its conflict-of-law provisions. To the extent court proceedings are permitted under these Terms, you consent to the exclusive jurisdiction of the state and federal courts located in Delaware.</p>
        </section>

        <section className="space-y-3">
          <h2 className="text-xl font-semibold text-zinc-800 border-b border-zinc-200 pb-2">15. Email Communications</h2>
          <div className="space-y-3 text-sm text-zinc-600">
            <p>By creating an account on {B}, you agree to receive transactional and service emails from us at the email address you registered with. These include emails related to your account security (password resets, login notifications), service updates, and important notices about changes to these Terms or the platform.</p>
            <p>From time to time we may also send you product updates, new feature announcements, and other communications about the service. You may opt out of non-transactional emails at any time by contacting us at <span className="font-medium text-zinc-800">{BRAND.supportEmail}</span>. You cannot opt out of transactional emails (such as password reset emails) while your account is active, as these are necessary to operate the service.</p>
          </div>
        </section>

        <section className="space-y-3">
          <h2 className="text-xl font-semibold text-zinc-800 border-b border-zinc-200 pb-2">16. Changes to These Terms</h2>
          <p className="text-sm text-zinc-600">{B} may update these Terms at any time by posting the revised version with an updated date. For material changes, we will make reasonable efforts to notify active users via a notice within the application or by email. Continued use of the service after the updated Terms are posted constitutes your acceptance of the changes.</p>
        </section>

        <section className="space-y-3">
          <h2 className="text-xl font-semibold text-zinc-800 border-b border-zinc-200 pb-2">17. Contact</h2>
          <p className="text-sm text-zinc-600">All questions, notices, DMCA requests, and legal correspondence should be sent to <span className="font-medium text-zinc-800">{BRAND.supportEmail}</span>. We will do our best to respond but cannot guarantee a response time.</p>
        </section>
