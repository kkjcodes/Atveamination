      ...
      <div className="max-w-3xl mx-auto py-12 px-6 space-y-10">
        ...
        <section className="space-y-3">
          ...
          <div className="space-y-3 text-sm text-zinc-600">
            ...
            <p><strong>30-day buffer.</strong> Deletion from our systems will be completed within 30 days of a deletion request. This window accounts for edge cases, API failures, and routine operational constraints. Data is not actively used after deletion is initiated.</p>
            <p>Deletion from third-party processors (Replicate, fal.ai) is subject to their own policies. {B} will make best-effort deletion requests to Replicate for trained model weights but cannot guarantee their timelines.</p>
          </div>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm text-zinc-600">
            We implement reasonable security measures including HTTPS and Azure access controls. <strong>No system is completely secure,</strong> and you acknowledge this risk by using the service. In the event of a confirmed data breach affecting your personal information, we will make best efforts to notify you via your registered email address as expeditiously as possible given our operational capacity, and in accordance with applicable legal obligations. We cannot guarantee notification within any specific timeframe.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <div className="space-y-3 text-sm text-zinc-600">
            <p>Depending on your jurisdiction, you may have the right to access, correct, delete, or export your personal data, or to restrict or object to its processing. To exercise these rights, email {BRAND.supportEmail}. We will respond on a best-effort basis and aim to answer within a few business days.</p>
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm text-zinc-600">{B} is for users aged 18 and over. We do not knowingly collect data from anyone under 18. If we become aware of such data, we will delete it promptly.</p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm text-zinc-600">For privacy questions, contact us at <span className="font-medium text-zinc-800">{BRAND.supportEmail}</span>. We read every message and aim to respond within a few business days.</p>
        </section>
